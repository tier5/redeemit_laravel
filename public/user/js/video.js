...
MyApp.controller('VideoListController',["$scope", "$rootScope", "PlaceholderTextService", "ngTableParams", "$filter", "$http", "fileToUpload", "$route", "$sce", function (a, rs, b, c, d, x, fu, r, sce) {            
