! function() {
    ...
    angular.module("redeemar-app", ["app.constants", "ngRoute", "ngAnimate", "ngSanitize", "angular.mdl", "ml.chat", "ml.menu", "ml.svg-map", "ml.todo", "ui.select", "ngFileUpload", "ngWig", "pikaday", "ngPlaceholders", "ngTable", "uiGmapgoogle-maps", "gridshore.c3js.chart", "angularGrid", "LocalStorageModule","myoffer-app"])
}(),
function() {
    "use strict";
    ...
    function a(a,file_path) {
        ...
        a.when("/", {
            templateUrl: site_path+"siteuser/dashboard.html"
        }).when("/:folder/:tpl", {
            templateUrl: function(a) {          
                return site_path+"siteuser/" + a.folder + "/" + a.tpl + ".html"
            }
        }).when("/:tpl", {
            templateUrl: function(a) {    
                return site_path+"siteuser/" + a.tpl + ".html"
            }
        }).otherwise({
            redirectTo: "/"
        })
...
function() {
    ...
    function() {
        ...
        angular.module("redeemar-app").controller("CategoryController", ["$scope", "PlaceholderTextService", "ngTableParams", "$filter", "$http", "fileUpload","$route", a])
    }(),
                        ...
                        if(response_back.response=="success")
                        {
                            ...
                            h.get("../admin/dashboard/vuforiarate/"+target_id+"/"+logo_id).success(function(target){
                                if(target.response=="success")
                                {
                                    ...
                                    var redirect_url=main_site_url+'/siteuser/dashboard#/tables/logo';                                   
    ...
    function() {
        ...
        function a() {
            ...
            return {
                restrict: "E",
                templateUrl: site_path+"siteuser/partials/header.html",
                replace: !0
            }
        }
    ...
    function() {
        ...
        function a() {
            ...
            return {
                restrict: "E",
                templateUrl: site_path+"siteuser/partials/sidebar.html",
                replace: !0
            }
        }
    ...
    function() {
        ...
        function b(a) {
            ...
            return {
                restrict: "EA",
                templateUrl: "../siteuser/_partials/todo-widget.html",
                replace: !0,
                link: b
            }
        }
