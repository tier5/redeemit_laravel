      ...
      <div class="container">
        <div class="row">
            <div class="col-md-12 col-sm-12">
                ...
                <div class="col-md-3 col-sm-3">
                    <img src="{{ asset('images/app-store.png') }}" class="img-responsive" />
                </div>
                <div class="col-md-3 col-sm-3">
                    <img src="{{ asset('images/google-play.png') }}" class="img-responsive" />
                </div>
                <div class="col-md-3 col-sm-3">
                    <img src="{{ asset('images/rar.png') }}" class="img-responsive img-rar" />
                </div>
            </div>
            <div class="col-md-12">
